...
export const destinationContent: DestinationContent[] = [
  {
    ...
    whenToGo: {
      months: months(['avoid', 'avoid', 'best', 'best', 'best', 'good', 'good', 'good', 'good', 'best', 'best', 'good']),
      description: {
  ...
  },
  {
    ...
    whenToGo: {
      months: months(['best', 'best', 'best', 'best', 'good', 'avoid', 'avoid', 'avoid', 'good', 'best', 'best', 'good']),
      description: {
  ...
  },
  {
    ...
    whenToGo: {
      months: months(['avoid', 'avoid', 'avoid', 'good', 'best', 'best', 'best', 'best', 'best', 'best', 'good', 'good']),
      description: {
  ...
  },
  {
    ...
    whenToGo: {
      months: months(['avoid', 'avoid', 'avoid', 'good', 'good', 'avoid', 'avoid', 'avoid', 'best', 'best', 'good', 'good']),
      description: {
