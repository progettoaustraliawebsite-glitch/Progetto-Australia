...
export const destinationContent: DestinationContent[] = [
  {
    ...
    intro: {
      it: 'Ogni viaggio in Australia viene progettato attorno alla persona, al suo stile di viaggio e al modo in cui desidera vivere questa esperienza. Dagli spostamenti ai tempi di percorrenza, dall\'equilibrio tra natura, città e relax fino alla scelta delle strutture, ogni dettaglio viene studiato per creare un itinerario fluido, autentico e realmente sostenibile nei ritmi.<br><br>L\'Australia non è una destinazione da visitare velocemente. È un paese da vivere con il ritmo giusto. Dalle città affacciate sull\'oceano agli spazi immensi dell\'Outback, dalle foreste tropicali del Queensland alle spiagge più remote, è un viaggio che cambia continuamente paesaggi, atmosfere ed emozioni. Ci sono luoghi che si ricordano per ciò che si vede. L\'Australia, invece, rimane soprattutto per la sensazione di libertà che lascia addosso.<br><br>Per questo ogni itinerario viene costruito su misura, con attenzione agli spostamenti, ai tempi di viaggio e al modo in cui desideri vivere davvero questa esperienza. <strong>Possiamo organizzare anche tour privati</strong>, per chi cerca un\'esperienza completamente personalizzata.',
      en: 'Every trip to Australia is designed around the person, their travel style, and the way they wish to experience it. From transfers to travel times, from the balance between nature, cities and relaxation to the choice of accommodation, every detail is carefully planned to create an itinerary that flows naturally, authentically and at a truly sustainable pace.<br><br>Australia is not a destination to be rushed. It is a country to experience at the right rhythm. From cities facing the ocean to the vast spaces of the Outback, from Queensland\'s tropical forests to its most remote beaches, it is a journey of ever-changing landscapes, atmospheres and emotions. There are places you remember for what you see. Australia stays with you above all for the feeling of freedom it leaves behind.<br><br>This is why every itinerary is tailor-made, with careful attention to transfers, travel times and the way you truly wish to live this experience. <strong>Private tours are also available</strong> for those seeking a fully personalised journey.',
    },
    whenToGo: {
    ...
    practical: {
      visa: { it: 'EVisitor (sottoclasse 651) gratuito, richiedibile online in pochi minuti.', en: 'EVisitor (subclass 651) free of charge, applicable online in minutes.' },
