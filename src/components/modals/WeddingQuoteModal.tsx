...
const copy = {
  it: {
    ...
    budget: 'Budget indicativo a persona, esclusi i voli *', selectBudget: 'Seleziona fascia',
    above: 'Oltre €7.500',
  ...
  en: {
    ...
    budget: 'Indicative budget per person, excl. flights *', selectBudget: 'Select range',
    above: 'Above €7,500',
    notes: 'Notes & Wishes',
